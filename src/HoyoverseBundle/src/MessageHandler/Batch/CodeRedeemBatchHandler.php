...
/**
 * @implements AbstractBatchTaskMessageHandler<CodeRedeemBatchMessage>
 */
#[AsMessageHandler]
class CodeRedeemBatchHandler
{
    ...
    protected function handleGameTask(GameInterface&HasCodeRedemptionInterface $gameService, CodeRedeemBatchMessage $message): void
    {
        try {
    ...
    private function handleAutoCodes(GameInterface&HasAutoCodeRedemptionInterface $gameService, array $redeemableCodes, array $gameProfiles): void
    {
        foreach ($gameProfiles as $gameProfile) {
            ...
            foreach ($redeemableCodes as $redeemableCode) {
                ...
                $this->bus->dispatch(
                    new CodeRedeemProfileMessage($profileId, $redeemableCode)
                );
