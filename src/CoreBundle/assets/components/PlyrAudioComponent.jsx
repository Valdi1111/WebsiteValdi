...
/**
 * Plyr wrapper for audio
 * @param {string} src base api url
 * @param {string} type file type
 * @returns {JSX.Element}
 * @constructor
 */
export default function PlyrAudioComponent({ src, type = "audio/mp3" }) {
    /**
    ...
    React.useEffect(() => {
        ...
        // Create audio element handled by Plyr (not by React)
        ...
        resizeObserver.observe(audio);

        // Initialize Plyr
        plyrInstance.current = new Plyr(audio, {
            keyboard: {
                focus: true,
                global: true,
            },
