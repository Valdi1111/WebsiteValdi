...
final class Version20250210201927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, shelf_id INT DEFAULT NULL, library_id INT DEFAULT NULL, url VARCHAR(255) NOT NULL, created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX FK_book_shelf (shelf_id), INDEX FK_book_library (library_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE book_cache (book_id INT NOT NULL, cover TINYINT(1) DEFAULT 0 NOT NULL, navigation JSON NOT NULL, locations JSON NOT NULL, pages INT AS (JSON_LENGTH(`locations`)) STORED, PRIMARY KEY(book_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
