...
/**
 * @extends AbstractTaskMessageHandler<HoyolabCheckInMessage>
 */
#[AsMessageHandler]
class HoyolabCheckInMessageHandler extends AbstractTaskMessageHandler
{

    public function __invoke(HoyolabCheckInMessage $message): void
    {
