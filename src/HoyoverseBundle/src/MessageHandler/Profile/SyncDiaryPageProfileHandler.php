...
/**
 * @implements AbstractProfileTaskMessageHandler<SyncDiaryPageProfileMessage>
 */
#[AsMessageHandler]
class SyncDiaryPageProfileHandler extends AbstractProfileTaskMessageHandler
{
    ...
    public function __invoke(SyncDiaryPageProfileMessage $message): void
    {
    ...
    ): void
    {
        ...
        if (count($diaryEntries) >= self::PAGE_SIZE) {
            ...
            $this->bus->dispatch(
                new SyncDiaryPageProfileMessage(
