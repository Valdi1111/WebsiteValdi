...
/**
 * @extends AbstractTaskMessageHandler<HilichurlTaskMessage>
 */
#[AsMessageHandler]
class HilichurlTaskMessageHandler extends AbstractTaskMessageHandler
{

    public function __invoke(HilichurlTaskMessage $message): void
    {
